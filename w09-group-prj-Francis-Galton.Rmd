...
The data set contains `r dim(mydf)[1]` records and `r dim(mydf)[2]` variables of the types integer, numeric, and factor. Please find a brief explanation for each variable below in the scollable table.   
...
### Data Set
The data set contains `r dim(mydf)[1]` records. Please find a subest of 200 data records below in the scollable table.  
